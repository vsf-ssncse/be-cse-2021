...
#+BEGIN_COMMENT
  ...
  No. of hours changed reflecting the depth of the syllabus
#+END_COMMENT
...
- Use SNA tools to work with SNA algorithms
- Use visualization tools to visualize Social Network 
...
{{{unit}}}
|UNIT III | COMMUNITY DETECTION METHODOLOGIES, APPLICATIONS | 10 |
...
- Utilize SNA tools for analysing social networks (K3)  
